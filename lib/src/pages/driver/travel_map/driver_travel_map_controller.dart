...
import 'package:order/src/api/environment.dart';
import 'package:order/src/models/travel_history.dart';
...
import 'package:order/src/providers/travel_history_provider.dart';
import 'package:order/src/providers/travel_info_provider.dart';
import 'package:order/src/providers/prices_provider.dart';
...
import 'package:order/src/widgets/bottom_sheet_driver_info.dart';
...
class DriverTravelMapController {
  ...
  void startTravel() async {
    print('la distancia ${_distanceBetween}');
